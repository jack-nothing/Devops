...
//						String value = BeanUtils.getProperty(item,
//								properties[i]);
...
//							List<Object> objs = (List<Object>) PropertyUtils
//									.getProperty(item, properties[i]);
//							for (int n = 0; n < 5; n++) {
//								for (int j = 0; j < 6; j++, i++, m++) {
//									cell = row.createCell(i);
//									String value = "";
//									try {
//										value = BeanUtils.getProperty(
//												objs.get(n), properties[m]);
//									} catch (Exception e) {
//										value = "";
//									}
//									cell.setCellValue(value);
...
//							String value = "";
//							try {
//								value = BeanUtils.getProperty(item,
//										properties[i]);
//							} catch (Exception e) {
//								value = properties[i];
//							}
...
//		// OutputStream os=new FileOutputStream(new File("D:\\temp\\file.xls"));
//		OutputStream os = response.getOutputStream();
//		workbook.write(os);
//		os.flush();
//		os.close();
//		/*
//		 * response.setContentType("application/force-download"); if
