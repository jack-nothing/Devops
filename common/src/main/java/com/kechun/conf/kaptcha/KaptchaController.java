...
public class KaptchaController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uasKaptcha")
	public void uasKaptcha(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/appKaptcha")
	public void appKaptcha(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
			throws Exception {
		byte[] captchaChallengeAsJpeg = null;
		ByteArrayOutputStream jpegOutputStream = new ByteArrayOutputStream();
		try {
